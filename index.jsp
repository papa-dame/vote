...
ResultSet rs=con.createStatement().executeQuery("SELECT * FROM parti WHERE id_parti=4");
...
ResultSet rs1=con.createStatement().executeQuery("SELECT * FROM parti WHERE id_parti=7");
        ...
        <main>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.jsp" style="color:green ;">
                        <strong><span></span>E- VOTE</strong>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="about.jsp">Story</a>
                            </li>
            ...
            <section class="slick-slideshow">   
                <div class="slick-custom">
                    <img src="images/macky.jpg" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="images/ousmane.jpg" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="images/thierno.jpg" class="img-fluid" alt="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="mb-5">D�marrer avec <span>E-</span> Vote</h2>
                        </div>
                            ...
                            <div class="tab-content mt-2" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        ...
                                        <%if(rs.next()){%> 
                                            <img src="images/<%=rs.getString(3)%>" class="img-fluid" alt="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.jsp">
                                    <img src="images/macky.jpg" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="images/thierno.jpg" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                <a href="product-detail.jsp">
                                    <img src="images/ousmane.jpg" class="img-fluid product-image" alt="">
                                </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-10 me-auto mb-4">
                        <h4 class="text-white mb-3"><a href="index.html">E-</a> VOTE</h4>
                        <p class="copyright-text text-muted mt-lg-5 mb-4 mb-lg-0">Copyright © 2022 <strong>E-Vote</strong></p>
                        <br>
